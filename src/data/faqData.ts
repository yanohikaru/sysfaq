    ...
    children: [
      {
        ...
        children: [
          ...
          },
          {
            id: '2-1-2',
            title: '緊急サポート',
            answer: '24時間365日、緊急時のサポートを提供しています。重大なインシデントの場合は、専門チームが即時対応いたします.',
            question: "緊急サポート",
            keywords: ["緊急", "サポート"]
          },
          {
            id: '2-1-3',
            title: '休日対応',
            answer: '土日祝日は基本的に休業となりますが、プレミアムサポートプランをご契約のお客様は休日でもサポートをご利用いただけます.',
            question: "休日対応",
            keywords: ["休日", "対応"]
          }
        ]
        ...
        children: [
          {
            ...
            question: "オンライントレーニング",
            keywords: ["オンライン", "トレーニング"]
          },
          {
            id: '2-2-2',
            title: '対面トレーニング',
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            id: '4-5-4',
            title: 'レポートテンプレート',
            answer: '独自のレポートテンプレートを作成・保存可能。グラフや表の形式もカスタマイズできます.',
            question: "レポートテンプレート",
            keywords: ["レポート", "テンプレート"]
          },
          {
            id: '4-5-5',
            title: 'ワークスペース設定',
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            id: '5-3-3',
            title: '契約更新',
            answer: '契約は自動更新となります。更新前にメールでお知らせし、変更・解約の機会を提供します.',
            question: "契約更新",
            keywords: ["契約", "更新"]
          },
          {
        ...
        children: [
          {
            ...
            question: "ボリュームディスカウント",
            keywords: ["ボリューム", "ディスカウント"]
          },
          {
            id: '5-5-2',
            title: 'スタートアップ支援',
